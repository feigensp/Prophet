...
public class EditorData {
	 ...
	 * 
	 * @param newRoot
	 *            the new root as so the new DataTreeNode-Tree
	 */
	...
	/**
	 * this methode will return you a Node out of the Data tree by the string
	 * identifier
	 * 
	 * @param name
	 *            string identifier from the node
	 ...
	 * 
	 * @param pathElements
	 *            the path as string array - the path determinated by the name
	 *            of the nodes
	 ...
	 * 
	 * @param sd
	 *            settingDialog which should be added
	 */
	 ...
	 * 
	 * @param name
	 *            stringIdentifier of the settingDialog
	 ...
	 * 
	 * @param name
	 *            string identifier of the settingsDialog which should be
	 *            deleted
