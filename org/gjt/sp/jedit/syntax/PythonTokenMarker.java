...
loop:
  ...
  public static KeywordMap getKeywords()
  {
    if (pyKeywords == null)
    {
      ...
      pyKeywords.add("and", Token.KEYWORD2);
      pyKeywords.add("not", Token.KEYWORD2);
      pyKeywords.add("or", Token.KEYWORD2);
      ...
      pyKeywords.add("def", Token.KEYWORD3);
      pyKeywords.add("class", Token.KEYWORD3);
      pyKeywords.add("lambda", Token.KEYWORD3);
      ...
      pyKeywords.add("Exception", Token.KEYWORD3);
      pyKeywords.add("StandardError", Token.KEYWORD3);
      pyKeywords.add("ArithmeticError", Token.KEYWORD3);
      pyKeywords.add("LookupError", Token.KEYWORD3);
      pyKeywords.add("EnvironmentError", Token.KEYWORD3);
      pyKeywords.add("AssertionError", Token.KEYWORD3);
      pyKeywords.add("AttributeError", Token.KEYWORD3);
      pyKeywords.add("EOFError", Token.KEYWORD3);
      pyKeywords.add("FloatingPointError", Token.KEYWORD3);
      pyKeywords.add("IOError", Token.KEYWORD3);
      pyKeywords.add("ImportError", Token.KEYWORD3);
      pyKeywords.add("IndexError", Token.KEYWORD3);
      pyKeywords.add("KeyError", Token.KEYWORD3);
      pyKeywords.add("KeyboardInterrupt", Token.KEYWORD3);
      pyKeywords.add("MemoryError", Token.KEYWORD3);
      pyKeywords.add("NameError", Token.KEYWORD3);
      pyKeywords.add("OSError", Token.KEYWORD3);
      pyKeywords.add("NotImplementedError", Token.KEYWORD3);
      pyKeywords.add("OverflowError", Token.KEYWORD3);
      pyKeywords.add("RuntimeError", Token.KEYWORD3);
      pyKeywords.add("SyntaxError", Token.KEYWORD3);
      pyKeywords.add("SystemError", Token.KEYWORD3);
      pyKeywords.add("SystemExit", Token.KEYWORD3);
      pyKeywords.add("TypeError", Token.KEYWORD3);
      pyKeywords.add("ValueError", Token.KEYWORD3);
      pyKeywords.add("ZeroDivisionError", Token.KEYWORD3);
    }
    return pyKeywords;
  }
...
/*
 * ChangeLog:
 * $Log: PythonTokenMarker.java,v $
 * Revision 1.5  2001/12/01 18:54:31  gfx
 * Various bug fixes
 *
