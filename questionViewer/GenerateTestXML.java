...
public class GenerateTestXML {
	...
	public static void main(String[] args) {
		...
		try {
			...
			child1.setTextContent("<html><head></head><body>frage 1 test<br><input name=\"vorname\" type=\"text\" size=\"30\" value=\"30\">");
			Element child2 = xmlTree.createElement("q2");
			child2.setAttribute("name", "q2");
			child2.setTextContent("<html><head></head><body>frage 2 test");
			Element child21 = xmlTree.createElement("q21");
			child21.setAttribute("name", "q21");
			child21.setTextContent("<html><head></head><body>frage 21 test");
			Element child22 = xmlTree.createElement("q22");
			child22.setAttribute("name", "q22");
			child22.setTextContent("<html><head></head><body>frage 22 test");
			Element child23 = xmlTree.createElement("q23");
			child23.setAttribute("name", "q23");
			child23.setTextContent("<html><head></head><body>frage 23 test");
