...
public class UIElementNames {
    ...
    public static String MESSAGE_DUPLICATE_TITLE_DUPLICATES_EXIST =
            "Form components with same name- and value- Attributes in node:";
    ...
    public static String MENU_TAB_SETTINGS_REQUIRED_ANSWER_COMPONENTS =
            "Components that must be contained in answers (one per line)";
    ...
    public static String MESSAGE_ONLY_ONE_INSTANCE =
    ...
    //ShowCIDECodePlugin
    public static String CIDE_HIGHLIGHT_SOURCE_CODE =
            "Highlight annotated source code with background colors (only avaible if source code is not editable)";
    ...
    public static String QUESTION_TREE_HTML_HANDLER_MESSAGE_ERROR_WHILE_READING =
            "Error while reading form names from XML file";
    ...
    public static void setUIElements(Locale locale) {
        ...
        EDITOR_TABBED_PANE_MESSAGE_ERROR_COULD_NOT_OPEN_FILE =
                labels.getString("EDITOR_TABBED_PANE_MESSAGE_ERROR_COULD_NOT_OPEN_FILE");
        ...
        //QuestionTreeHTMLHandler
        QUESTION_TREE_HTML_HANDLER_MESSAGE_ERROR_WHILE_READING =
                labels.getString("QUESTION_TREE_HTML_HANDLER_MESSAGE_ERROR_WHILE_READING");
        QUESTION_TREE_XML_MESSAGE_ERROR_WHILE_WRITING_CSV =
                labels.getString("QUESTION_TREE_XML_MESSAGE_ERROR_WHILE_WRITING_CSV");
