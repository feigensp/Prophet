...
public class LanguageEditor extends JFrame {
    ...
    private void setListener() {
        ...
        saveAsMenuItem.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                if (keywords.size() == 0) {
                    JOptionPane.showMessageDialog(null, "Keine Sprache vorhanden. Datei wird nicht gespeichert.");
                } else {
        ...
        fallbackLanguageButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                if (comboBox.getSelectedIndex() != -1) {
                    fallbackLanguageButton.setText(DEFAULT_LANGUAGE_DEFINED + comboBox.getSelectedItem().toString());
                }
            }
        });
        // add keyword
