...
public class LanguageXMLHandler {
     ...
     */
    public static void save(String path, TreeMap<String, TreeMap<String, String>> givenKeywords,
                ...
                if (lanNode.getNodeName().equals(ELEMENT_DEFAULT_LANGUAGE)) {
                    ...
                    for (int j = 0; j < keyList.getLength(); j++) {
                        ...
                        String interpretString =
                                keyNode.getAttributes().getNamedItem(ATTRIBUTE_INTERPRETATION).getNodeValue();
