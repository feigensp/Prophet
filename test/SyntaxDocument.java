...
class SyntaxDocument extends DefaultStyledDocument {
	...
	public static final Color STANDART_COMMENT_COLOR = new Color(63, 127, 95);
	public static final Color STANDART_KEYWORD_COLOR = new Color(127, 0, 85);
	public static final Color STANDART_QUOTE_COLOR = new Color(42, 0, 255);
	...
	public SyntaxDocument() {
		...
		StyleConstants.setForeground(comment, STANDART_COMMENT_COLOR);

		keyword = new SimpleAttributeSet();
		StyleConstants.setForeground(keyword, STANDART_KEYWORD_COLOR);
		StyleConstants.setBold(keyword, true);

		quote = new SimpleAttributeSet();
		StyleConstants.setForeground(quote, STANDART_QUOTE_COLOR);
